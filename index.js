...
const accounts = [
    ...
    { email: process.env.U_MAIL_3, password: process.env.U_PASS_3, roomId: 18555555 },
    ...
    { email: process.env.U_MAIL_6, password: process.env.U_PASS_6, roomId: 330865 },
    { email: process.env.U_MAIL_7, password: process.env.U_PASS_7, roomId: 330865 },
    ...
    { email: process.env.U_MAIL_10, password: process.env.U_PASS_10, roomId: 330865 },
