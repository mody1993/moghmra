...
const ROOM_ID = 569; // ضع معرف الغرفة
...
function sendCommands(client, accountNumber) {
    ...
    setTimeout(() => {
        ...
        console.log(`[الحساب ${accountNumber}] تم إرسال !مغامرة تحالف ايداع كل`);

    }, 3000);
}

// تسجيل الدخول بالتتابع
accounts.forEach((account, index) => {
    ...
    }, index * 2000); // ثانيتان بين كل عملية تسجيل دخول
});
